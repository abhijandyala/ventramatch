...
/**
 * /reference/confirm?token=<rawToken>
 *
 * Public page — no sign-in required. The referee clicks the magic link
 * from their email and lands here. They can write a short endorsement
 * (optional) then confirm, or decline without writing anything.
 *
 * Token must be 64 hex chars (sha256 input is 32 random bytes → 64-char hex).
 * DB update happens via server actions in ./actions.ts.
 */
