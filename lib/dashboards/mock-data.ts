...
export const founderDashboardMock: FounderDashboard = {
  ...
  profileStrength: {
    ...
    checklist: [
      { id: "deck", label: "Pitch deck uploaded", href: "/build#deck", done: true },
      {
        id: "core",
      ...
      { id: "traction", label: "Traction added", href: "/build#traction", done: true },
      { id: "location", label: "Location set", href: "/build#location", done: false },
      { id: "linkedin", label: "Founder LinkedIn linked", href: "/build#linkedin", done: false },
    ],
  },
  investorInterest: {
    interestedCount: {
...
export const investorFeedMock: InvestorFeed = {
  ...
  profileStrength: {
    ...
    checklist: [
      { id: "firm", label: "Firm name and role set", href: "/build#firm", done: true },
      { id: "thesis", label: "Investment thesis added", href: "/build#thesis", done: true },
      { id: "check", label: "Check size range set", href: "/build#check", done: true },
      { id: "sectors", label: "Sectors selected", href: "/build#sectors", done: true },
      { id: "linkedin", label: "LinkedIn linked", href: "/build#linkedin", done: false },
    ],
  },
  profilePerformance: {
    stats: [
