// Generated by Supabase CLI: `npm run db:types`
// This file is checked in so PRs can review schema changes alongside code.
// Until the first migration is applied locally, this is a hand-written stub
// that mirrors `supabase/migrations/0001_initial_schema.sql`.
